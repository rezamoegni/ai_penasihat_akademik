...
3) Google API Key disimpan sebagai Streamlit Secrets
...
# Wajib ada API key
if not google_api_key:
    st.error("GOOGLE_API_KEY belum tersedia di Secrets. Buka Settings → Secrets di Streamlit Cloud lalu set GOOGLE_API_KEY.")
    st.stop()
